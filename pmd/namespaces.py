...
GSSDATA = Namespace('http://gss-data.org.uk/data/')
GSSGRAPH = Namespace('http://gss-data.org.uk/graph/')
PROV = Namespace('http://www.w3.org/ns/prov#')
...
namespaces.bind('foaf', FOAF)
namespaces.bind('prov', PROV)
namespaces.bind('gssdata', GSSDATA)
namespaces.bind('gssgraph', GSSGRAPH)