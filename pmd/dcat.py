...
from namespaces import DCAT, PROV, ODRL
from base import Metadata, Status
...
class Resource(Metadata):
    ...
    _properties_metadata.update({
        ...
        'landingPage': (DCAT.landingPage, Status.recommended, URIRef),  # foaf:Document
        ...
        'wasDerivedFrom': (PROV.wasDerivedFrom, Status.recommended, URIRef)
    })
